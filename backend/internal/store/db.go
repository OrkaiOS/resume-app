...
func migrate(db *sql.DB) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS user_settings (
			...
			llm_model TEXT,
			llm_api_key TEXT,
			orkai_category_id TEXT,
			canonical_profile_standard_id TEXT,
			cover_letter_principles_standard_id TEXT,
			pdf_pipeline_standard_id TEXT,
			pdf_generation_skill_id TEXT,
			onboarded_at TEXT,
			created_at TEXT NOT NULL,
			updated_at TEXT NOT NULL
		)`,
